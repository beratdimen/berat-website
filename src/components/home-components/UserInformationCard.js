...
export default function UserInformationCard() {
  return (
    <Container
      style={{ backgroundImage: "url(./img/yazilim-image.jpg)" }}
      ...
      <Stack direction="row">
        ...
        >
          <CardContent sx={{ alignItems: "center", textAlign: "center" }}>
            ...
            <Typography level="title-lg">Berat DİMEN</Typography>
            <Typography level="body-sm" sx={{ maxWidth: "24ch" }}>
              Merhaba, ben freelance front end developerım
              react,javscript,html,css üzerinde web sitesi geliştirebiliyorum .
            </Typography>
            <Box
              sx={{
                display: "flex",
        ...
        >
          ...
          <Divider inset="none" />
          <Stack>
            Merhaba , ben Berat Dimen 2 senedir Front end developer olarak
            çalışıyorum becerilerim javscript, react.js, html,css dilleri ile
            web sitesi düzenleyebiliyorum. Önceliğim siz değerli müşterilemizin
            memnuniyeti sizler içn düzenlediğim siteleri özenli ve güzel bir
            şekilde hazırlıyoruz aynı zaman da siteniz bittikten sonra da
            hizmetimden yararlanabilirsiniz.
          </Stack>
          <Stack direction="row">
            <Stack direction="column" pr={1}>
              <Typography>Yaş:...24</Typography>
              <Stack pr={1}>
                <Typography mb={2}>Freelance:...Mevcut</Typography>
              </Stack>
            </Stack>
            <Stack direction="column">
              {" "}
              <Typography>İkametgah: TÜRKİYE</Typography>
              <Stack>
                {" "}
                <Typography>ADRES: İstanbul, Türkiye</Typography>{" "}
              </Stack>
            </Stack>
          </Stack>

          <Stack>
            <Typography> Başarılarım </Typography>
          </Stack>
          <Grid
            container
            display="grid"
          ...
          >
            <Grid item sx={{ display: "flex" }}>
              ...
              >
                ...
                <CardContent>
                  <Typography level="title-md">Twitch Streaming</Typography>
                  <Typography>
                    American video live streaming service that focuses on video
                    game live streaming.s
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid item sx={{ display: "flex" }}>
              ...
              >
                ...
                <CardContent>
                  <Typography level="title-md">Advetising</Typography>
                  <Typography>
                    Advertising services include twitch streams, youtube videos,
          ...
          >
            <Grid item sx={{ display: "flex" }}>
              <Card variant="outlined">
                ...
                <CardContent>
                  <Typography level="title-md">Youtube Videos</Typography>
                  <Typography>
                    YouTube specialist for hire and outsource all your video
                    production needs.
                  </Typography>
                </CardContent>
              </Card>
            ...
            <Grid item sx={{ display: "flex" }}>
              <Card variant="outlined">
                ...
                <CardContent>
                  <Typography level="title-md">Let's Play</Typography>
                  <Typography>
                    Playthrough of a video game, usually including commentary
                    and camera view of the gamers face.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
